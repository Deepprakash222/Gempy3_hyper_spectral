...
def main():
    ...
    nuts_kernel = NUTS(model.model_test, step_size=0.0085, adapt_step_size=True, target_accept_prob=0.8, max_tree_depth=10, init_strategy=init_to_mean)
    ...
    MAP_sample_index, max_posterior_value = compute_map(posterior_samples,geo_model_test,normalised_hsi,test_list,y_obs_label, mean_init,cov_init, factor, directory_path,num_layers,posterior_condition,scale, cluster, alpha, beta , dtype,device)
